...
void loop()
{
  if (digitalRead(button) == LOW)
  {
    ...
    //************************************************************
          ...
          delay(2880);
          small_stepper.setSpeed(9);
          small_stepper.step(500);
          small_stepper.setSpeed(9);
          small_stepper.step(-159);
          small_stepper.setSpeed(5);
          ...
          small_stepper.setSpeed(3);
          small_stepper.step(-93);
          small_stepper.setSpeed(4);
          small_stepper.step(-98);
          delay(7200);
          small_stepper.setSpeed(9);
          small_stepper.step(451);
          small_stepper.setSpeed(4);
          small_stepper.step(43);
          small_stepper.setSpeed(9);
          small_stepper.step(-219);
          small_stepper.setSpeed(3);
          ...
          small_stepper.step(18);
          small_stepper.setSpeed(5);
          small_stepper.step(224);
          small_stepper.setSpeed(3);
          small_stepper.step(73);
          delay(120);
          small_stepper.setSpeed(7);
          small_stepper.step(-142);
          small_stepper.setSpeed(3);
          small_stepper.step(-77);
          delay(720);
          small_stepper.setSpeed(3);
          small_stepper.step(-102);
          small_stepper.setSpeed(1);
          small_stepper.step(-88);
          delay(1120);
          small_stepper.setSpeed(9);
          ...
          small_stepper.step(33);
          small_stepper.setSpeed(9);
          small_stepper.step(183);
          small_stepper.setSpeed(4);
          small_stepper.step(60);
          small_stepper.setSpeed(9);
          small_stepper.step(-342);
          small_stepper.setSpeed(9);
          small_stepper.step(122);
          small_stepper.setSpeed(6);
          small_stepper.step(49);
          ...
          small_stepper.step(134);
          small_stepper.setSpeed(1);
          small_stepper.step(9);
          small_stepper.setSpeed(5);
          small_stepper.step(75);
          small_stepper.setSpeed(9);
          small_stepper.step(-317);
          small_stepper.setSpeed(2);
          small_stepper.step(76);
          small_stepper.setSpeed(6);
          small_stepper.step(-65);
